...
# notes Peter Dyce made while doing this tutorial

I started here to learn Angular2. " https://angular.io/docs/ts/latest/quickstart.html ""
Follow the set up documenation above ( also on the original github repository)

#Tut 1

/*   app.module.ts  listing */

/* import the modules from the installed angular libs 
   as in above ...
	Install the npm packages described in the `package.json` and verify that it works:

	```
	cd into the app dir   // see above
	npm install           //  install the libs for the app
	npm start 			  //  start the JIT  to  watch this dir for file changes
	```
*/


/*  ----  --- src/app/app.modules   --- */
/*  ---- this is the import of modules from libraries --- */
...
@Component({
 ...
 /*  ---- this is the new html tag to place the component  on the page --- */
 
   selector: 'my-app',      

/*  ---- this is defining the template in @Component  --- */
/*  ---- not the `...` back ticks which allow multi line formatting --- */
 

    template: `<h1>{{title}}</h1><h2>{{hero}} details!</h2>`

/*  ---- Double brackets enclose variable names etc etc  --- */
...
/*  ----At the moment it is a static class   --- */
/*  ----with a title and a hero wit a name   --- */
